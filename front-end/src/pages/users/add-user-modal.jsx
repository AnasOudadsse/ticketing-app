  ...
  return (
    ...
    >
      <div className="space-y-4">
        <p>
          Are you sure you want to discard your changes? All unsaved data will
          be lost.
        </p>
...
export default function AddUserModal({ isOpen, onClose, onSuccess }) {
  ...
  const handleSpecialisationChange = (id, checked) => {
    if (checked) {
      ...
      setSpecialisation((prev) =>
        prev.filter((specId) => specId !== id.toString())
      );
    }
    setIsDirty(true);
  };
  ...
  const canProceedToDetails = () => {
    ...
    return requiredBasicFields.every(
                ...
                <div className="space-y-4">
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className={`pl-3 h-11 mt-2 transition-all duration-200 ${
                        errors.name
                  ...
                  <div className="relative">
                    ...
                    >
                      <SelectTrigger
                        className={`h-11 mt-2 transition-all duration-200 ${
                          errors.role
                            ? "border-red-500 bg-red-50"
                            : "focus:border-blue-500 focus:ring-blue-500"
                        }`}
                        ...
                        {info.specialisations.map((specialisation) => (
                          ...
                          >
                            <Checkbox
                              ...
                              checked={specialisations.includes(
                                specialisation.id.toString()
                              )}
                ...
                <div className="space-y-4">
                  <div className="relative">
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        handleSelectChange("fonction_id", value)
                      }
                    >
                      <SelectTrigger
                        className={`h-11 mt-2 transition-all duration-200 ${
                  ...
                  <div className="relative">
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        handleSelectChange("departement_id", value)
                      }
                    >
                      <SelectTrigger
                        className={`h-11 mt-2 transition-all duration-200 ${
                  ...
                  <div className="relative">
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        handleSelectChange("localisation_id", value)
                      }
                    >
                      <SelectTrigger
                        className={`h-11 mt-2 transition-all duration-200 ${
